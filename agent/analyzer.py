...
class CertificateAnalyzer(
    ...
    Composed from mixins split out of this file (each documents which methods
    ...
    _EventContextMixin (agent/event_context.py), _CertParsingMixin
    (agent/cert_parsing.py), for now, more to follow.
    """
