...
_CONNECT_SCHEMA_FIELDS = [
    ...
    ('ocsp_responder_urls',           'array_string', True),
    ('ca_issuers_urls',               'array_string', True),
    ('is_ca',                         'boolean', True),
...
class KafkaPublisher:
    ...
    def publish(self, cert_info: CertificateInfo) -> None:
        ...
        message = {
            ...
            'fips_checked':      cert_info.fips_checked,
            ...
            'ocsp_responder_urls':           cert_info.ocsp_responder_urls,
            'ca_issuers_urls':               cert_info.ca_issuers_urls,
