...
def _dial_outbound_tls_port(params: dict) -> UseCaseResult:
    ...
    return UseCaseResult(
        ...
        detail=(
            ...
            "skipped -- the helper cycles across 13 candidate ports, so expect roughly that "
...
USE_CASES: List[UseCase] = [
    ...
    UseCase(
        ...
        pipeline=[
            ...
            "9093, 9094, 2376, 4443, 5986, 6443, 8140, 9443 -- a subset "
            "that doesn't need root to bind), "
