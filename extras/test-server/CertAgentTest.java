 ...
 *
 * Vendored from probe_tests/java/CertAgentTest.java for the
 * java-jca-keystore test-server use case (see use_cases.py) -- kept
 * byte-for-byte identical so the manual jattach procedure documented in
 * probe_tests/README.md and this use case exercise the exact same class.
 */
