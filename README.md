...
| MCP server (read-only) | `certsight-demo.com:8092/mcp` | Query fleet cert/FIPS/chain data live from Claude Desktop or Claude Code - bearer-token gated (not a browser link); see [setup instructions](extras/mcp-server/MCP-SERVER-README.md#running-over-the-network-streamable-http) |
