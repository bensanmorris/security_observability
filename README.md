...
| **CertSight** | Every cert access at runtime with process and k8s context | Statically linked crypto that never calls system crypto libs (excluding Java / JCA - we've got that covered) |
