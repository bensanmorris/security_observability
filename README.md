...
Utilises eBPF to hook kprobes and uprobes to detect certificate accesses, then parses and exposes certificate, process and k8s (where applicable) data as Prometheus metrics and Kafka topics.
